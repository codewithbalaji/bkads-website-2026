...
const THEMES = {
  primary: "from-neutral-700 via-neutral-800 to-neutral-900",
  secondary: "from-neutral-700 via-neutral-800 to-neutral-900",
  accent: "from-neutral-700 via-neutral-800 to-neutral-900",
  success: "from-neutral-700 via-neutral-800 to-neutral-900",
  warning: "from-neutral-700 via-neutral-800 to-neutral-900",
  danger: "from-neutral-700 via-neutral-800 to-neutral-900",
  info: "from-neutral-700 via-neutral-800 to-neutral-900",
  neutral: "from-neutral-700 via-neutral-800 to-neutral-900",
} as const;
  ...
  return (
    <div className="relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 text-foreground opacity-[0.015]">
        ...
        <motion.div
          className="absolute top-10 right-10 w-64 h-64 text-foreground opacity-[0.03]"
        ...
        <motion.div
          className="absolute bottom-10 left-10 w-48 h-48 text-foreground opacity-[0.02]"
...
export const Animated3dCard = ({ cards }: Animated3dCardProps) => {
  return (
